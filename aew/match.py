...
CATEGORY_KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    "goods": (
        ...
        "フィギュア", "プラモデル", "ガンプラ", "ねんどろいど",
        "アクリルスタンド", "アクスタ", "缶バッジ", "一番くじ",
        "blu-ray", "dvd", "円盤", "box", "サウンドトラック", "サントラ",
        "復刻版", "限定商品", "コラボ商品", "新商品", "発売決定", "発売開始",
    ),
    "concert": (
...
# 催しでも商品でもないものを落とす。
# Blu-ray やグッズは goods カテゴリに移したので、ここには置かない
# （カテゴリを無効にしていれば classify が空を返して落ちる）。
_EXCLUDE = (
    "配信開始", "配信決定", "配信情報", "ゲーム化", "アプリ配信",
    "声優 誕生日", "ランキング発表",
)
